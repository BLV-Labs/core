...
func (q queryServer) ProposalMinimalLUNCByUusd(ctx sdk.Context, req *v2lunc1types.QueryProposalRequest) (*v2lunc1types.QueryMinimalDepositProposalResponse, error) {
