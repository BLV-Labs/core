...
import (
    ...
    v2 "github.com/classic-terra/core/v3/custom/gov/types/v2lunc1"
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg, err := v1.MsgSubmitProposal(msgs, deposit, clientCtx.GetFromAddress().String(), metadata, title, summary)
			if err != nil {
